...
* state
* facility name
* ORIS code: the numeric identifier assigned to the facility (power plant) for EPA reporting purposes
* unit ID: identifier for generating units (generator) at the facility (power plant)
* operating date: the date of reported generation/emissions
* operating hour: the clock hour of the day in which a particular pollutant concentration or flow rate was recorded (range of values 00-23)
